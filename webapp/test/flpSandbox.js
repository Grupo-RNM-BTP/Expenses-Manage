		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zfiexpensesmanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfiexpensesmanage-display": {
								"semanticObject": "zfiexpensesmanage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfiexpensesmanage",
									"url": sap.ui.require.toUrl("zfiexpensesmanage")
								}
							}
						}
					}
